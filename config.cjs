...
const config = {
  SESSION_ID: process.env.SESSION_ID || JOEL-XMD~lFIgVKJD#L7LJn7iY0bIZ0bbiNvCtgDU_eSEwGzUfpClDIfz9-2A
...
// don't use my codes without a permission 🙏
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "25571459507",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "27682679605",
